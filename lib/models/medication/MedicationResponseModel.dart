...
//
//     final medicationResponseModel = medicationResponseModelFromJson(jsonString);
...
class MedicationResponseModel {
  ...
  factory MedicationResponseModel.fromRawJson(String str) =>
      MedicationResponseModel.fromJson(json.decode(str));
