...
HealthWellnessResponseModel healthWellnessResponseModelFromJson(String str) => HealthWellnessResponseModel.fromJson(json.decode(str));

String healthWellnessResponseModelToJson(HealthWellnessResponseModel data) => json.encode(data.toJson());
...
class HealthWellnessResponseModel {
  ...
  factory HealthWellnessResponseModel.fromJson(Map<String, dynamic> json) => HealthWellnessResponseModel(
