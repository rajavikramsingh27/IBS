...
class AutoCompleteTextField<T> extends StatefulWidget {
  ...
  final GlobalKey<AutoCompleteTextFieldState<T>> autoKey;
  ...
  void clear() => autoKey.currentState.clear();

  void addSuggestion(T suggestion) =>
      autoKey.currentState.addSuggestion(suggestion);

  void removeSuggestion(T suggestion) =>
      autoKey.currentState.removeSuggestion(suggestion);

  void updateSuggestions(List<T> suggestions) =>
      autoKey.currentState.updateSuggestions(suggestions);

  void triggerSubmitted() => autoKey.currentState.triggerSubmitted();
  ...
  void updateDecoration(
      ...
      autoKey.currentState.updateDecoration(decoration, inputFormatters,
          textCapitalization, style, keyboardType, textInputAction);

  TextField get textField => autoKey.currentState.textField;
...
class AutoCompleteTextFieldState<T> extends State<AutoCompleteTextField> {
  ...
  List<T> getSuggestions(List<T> suggestions, Comparator<T> sorter,
    ...
    suggestions =
        suggestions.where((item) => filter(item, query) ?? false).toList();
