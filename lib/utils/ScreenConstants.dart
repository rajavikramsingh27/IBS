...
class ScreenConstant {
  ...
  static double sizeUltraXXXXL = 80.0;
  ...
  static double defaultSizeThreeHundred = 300;
  ...
  static void setScreenAwareConstant(context) {
    ...
    sizeUltraXXXXL = DeviceManager.instance.setWidth(80.0);
    ...
    defaultSizeThreeHundred = DeviceManager.instance.setHeight(300);
