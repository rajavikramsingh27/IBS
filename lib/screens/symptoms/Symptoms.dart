                                                                    ...
                                                                    GridView
                                                                      ...
                                                                      itemBuilder:
                                                                        ...
                                                                        return InkWell(
                                                                          onTap:
                                                                              () {
                                                                            _symptomsController.onOptionTapped(
                                                                                model: model,
                                                                                modelValue: _symptomsController.symptomsModel.value.items[index].children.first.value.arr);
                                                                          },
                                                                          child: Card(
                                                                              elevation: 0,
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        value: _signUpController.symptoms.value.items[index].children.first.items.last.select.selectDefault.label !=
                                                                            ...
                                                                            : _signUpController.symptoms.value.items[index].children.first.items.last.select.options.first,
                                                                        ...
                                                                        onChanged:
                                                                          ...
                                                                          ChildValue
                                                                              childValue =
                                                                              ChildValue(str: optionItem.value);
                                                                          Child child = Child(
                                                                              tid: _signUpController.symptoms.value.items[index].children.first.items.last.tid,
                                                                              dtype: "str",
                                                                              kind: "select",
                                                                              value: childValue);
