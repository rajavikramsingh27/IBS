          ...
          children: <TextSpan>[
            ...
            TextSpan(
                ...
                recognizer: TapGestureRecognizer()
                  ..onTap = () async {
                    final _url =
                        'https://www.badgut.org/wp-content/uploads/IBS-Global-Impact-Report.pdf';
          ...
          children: <TextSpan>[
            ...
            TextSpan(
                ...
                recognizer: TapGestureRecognizer()
                  ..onTap = () async {
                    final _url =
                        'https://badgut-5q10xayth7t3zjokbv.netdna-ssl.com/wp-content/uploads/IBS-Global-Impact-Report.pdf';
                    await canLaunch(_url)
                        ? await launch(_url)
                        : throw 'Could not launch $_url';
                  }),
